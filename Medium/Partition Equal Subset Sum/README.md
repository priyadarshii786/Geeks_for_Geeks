<h2><a href="https://practice.geeksforgeeks.org/problems/subset-sum-problem2014/1?page=3&sprint=50746f92a895c22a50504ac0c1fb9c84&sortBy=submissions">Partition Equal Subset Sum</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array&nbsp;<strong>arr[]</strong> of size&nbsp;<strong>N</strong>, check if&nbsp;it can be partitioned into two parts such that the sum of elements in both parts&nbsp;is the same.</span></p>
