<h2><a href="https://practice.geeksforgeeks.org/problems/rearrange-characters4649/1?page=6&category=Strings&sortBy=submissions">Rearrange characters</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string S with repeated characters. The task is to rearrange characters in a string such that no two adjacent characters are the same.<br>
