<h2><a href="https://practice.geeksforgeeks.org/problems/display-longest-name0853/1?page=3&category[]=Strings&sortBy=submissions">Display longest name</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a list of names, display the longest name.</span></p>
