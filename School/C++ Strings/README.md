<h2><a href="https://practice.geeksforgeeks.org/problems/c-strings4609/1?page=6&category=Strings&sortBy=submissions">C++ Strings</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two strings&nbsp; S1 and S2 .&nbsp;You have to concatenate both the strings and print the concatenated string.</span></p>
