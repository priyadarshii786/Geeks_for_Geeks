<h2><a href="https://practice.geeksforgeeks.org/problems/reversing-the-vowels5304/1?page=5&category[]=Strings&sortBy=submissions">Reversing the vowels</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string consisting of lowercase english alphabets, reverse only the vowels present in it and print the resulting string.</span></p>
